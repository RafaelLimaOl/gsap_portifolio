...
const Footer = () => {
  return (
    <>
      ...
      <footer className="main-container grid gap-10 py-20 md:grid-cols-2 lg:grid-cols-4">
        <img src={Logo} alt="" />
        <div>
      ...
      <div className="main-container grid gap-3 py-6 md:grid-cols-2 lg:py-8">
